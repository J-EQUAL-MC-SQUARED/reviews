...
const stream1 = fs.createWriteStream('./database/data/items5.csv');
const stream2 = fs.createWriteStream('./database/data/reviews5.csv');
const stream3 = fs.createWriteStream('./database/data/images5.csv');
