...
const stream1 = fs.createWriteStream('./database/data/items3.csv');
const stream2 = fs.createWriteStream('./database/data/reviews3.csv');
const stream3 = fs.createWriteStream('./database/data/images3.csv');
