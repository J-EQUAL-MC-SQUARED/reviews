...
const stream1 = fs.createWriteStream('./database/data/items2.csv');
const stream2 = fs.createWriteStream('./database/data/reviews2.csv');
const stream3 = fs.createWriteStream('./database/data/images2.csv');
