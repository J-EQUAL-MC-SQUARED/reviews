...
const stream1 = fs.createWriteStream('./database/data/items7.csv');
const stream2 = fs.createWriteStream('./database/data/reviews7.csv');
const stream3 = fs.createWriteStream('./database/data/images7.csv');
