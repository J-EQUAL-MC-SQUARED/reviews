...
const stream1 = fs.createWriteStream('./database/data/items9.csv');
const stream2 = fs.createWriteStream('./database/data/reviews9.csv');
const stream3 = fs.createWriteStream('./database/data/images9.csv');
