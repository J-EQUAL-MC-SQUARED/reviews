...
const stream1 = fs.createWriteStream('./database/data/items1.csv');
const stream2 = fs.createWriteStream('./database/data/reviews1.csv');
const stream3 = fs.createWriteStream('./database/data/images1.csv');
