...
const stream1 = fs.createWriteStream('./database/data/items4.csv');
const stream2 = fs.createWriteStream('./database/data/reviews4.csv');
const stream3 = fs.createWriteStream('./database/data/images4.csv');
