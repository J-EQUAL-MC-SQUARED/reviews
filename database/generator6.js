...
const stream1 = fs.createWriteStream('./database/data/items6.csv');
const stream2 = fs.createWriteStream('./database/data/reviews6.csv');
const stream3 = fs.createWriteStream('./database/data/images6.csv');
