...
const stream1 = fs.createWriteStream('./database/data/items8.csv');
const stream2 = fs.createWriteStream('./database/data/reviews8.csv');
const stream3 = fs.createWriteStream('./database/data/images8.csv');
